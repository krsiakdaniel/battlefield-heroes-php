...
<head>
	<title>BF Heroes - Armies - Royal Army</title>
	<?php
...
<!-- MAIN CONTENT - S -->
	...
	<div>
     <!-- LEFT SIDE - S -->
	<a href="armies-royal-army.php"><span class="submenu-2">Royal Army</span></a>
	&nbsp; <a href="armies-national-army.php"><span class="submenu-1">National Army</span></a>
     <!-- LEFT SIDE - E -->
...
-->
<p class="align-c">
<img src="images/build-pics/armies/royal-army/trans-armies-baw-n.png" width="655" height="423" alt="ROYAL ARMY" usemap="#royal" class="border-none img-padding" />
<map name="royal" id="royal">
	<area id="national-army" shape="rect"
	coords="530,350,590,400"
	alt="Royal Army"
	href="armies-national-army.php" />
</map>
</p>
<!-- COORDS ... LEFT,TOP + RIGHT,BOTTOM - E -->

<img src="images/build-pics/armies/royal-army/trans-royal-flag.png" width="142" height="146" alt="Royal Flag" class="float-l img-padding" />
<br />
<strong>Royal Army</strong>
<p>
...
<table class="custom-div-blue" width="804">
<tr>
<td class="t-td-50">
<img src="images/icon/32x32/32x32-trans-r-flag.png" width="32" height="32" alt="Royal Army" />
</td>
<th class="t-th-754">
<hr />
...
<tr>
<td>
<a href="classes-soldier.php"><img src="images/build-pics/armies/royal-army/trans-soldier-r.png" width="256" height="256" alt="SOLDIER" class="border-none" /></a>
</td>
<td>
<a href="classes-gunner.php"><img src="images/build-pics/armies/royal-army/trans-gunner-r.png" width="256" height="256" alt="GUNNER" class="border-none" /></a>
</td>
<td>
<a href="classes-commando.php"><img src="images/build-pics/armies/royal-army/trans-commando-r.png" width="256" height="256" alt="COMMANDO" class="border-none" /></a>
</td>
</tr>
</table>
<!-- TEXT n PICS - E -->
