...
-->
<p class="align-c">
	<img src="images/build-pics/armies/trans-armies.png" width="655" height="423" alt="CHOOSE FACTION" usemap="#armies" class="border-none img-padding" />
	<map name="armies" id="armies">
