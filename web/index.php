...
<body onload="window.status='* Webdesign and code by \'Krysak4eveR\' *'">
	...
	<div class="info">My first website ever. Made in 2009.</div>
	...
	<div id="div-container">
		...
		<div class="tbox-border-white">
			<div id="tbox-auto">
				...
				<div>
					<!-- LEFT SIDE - S -->
					<a href="news-archive.php"><span class="submenu-1">News Archive</span></a>
					<!-- LEFT SIDE - E -->
				...
				<p class="custom-div-blue">
					<strong><sub>2009 *</sub> august</strong>
				</p>
				<!-- TEXT n PICS - E -->
			</div>
		</div>
