...
<head>
	<title>BF Heroes - Abilities</title>
	<?php
...
-->
<p class="align-c">
<img src="images/build-pics/abilities/trans-abilities.png" width="655" height="423" alt="ABILITIES" usemap="#abilities" class="border-none img-padding" />
